...
export async function stockScraping( previousDay:string, today:string) {
  ...
  const priceResult = await axios.get('https://api.finmindtrade.com/api/v4/data?', {
    params: {
      ...
      end_date: today,
      token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRlIjoiMjAyMy0wNy0wNyAyMDoyNjoyNCIsInVzZXJfaWQiOiJoYXdoYXdsYWIiLCJpcCI6IjU5LjEyMC4xMS4xMjUifQ.KV4ujoqXxTNDFDTjUbs13fYcP8aUu8mn-HNCRYiZHhc'
    }
  });
